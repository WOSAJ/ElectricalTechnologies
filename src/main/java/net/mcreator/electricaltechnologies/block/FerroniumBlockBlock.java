...
public class FerroniumBlockBlock extends ElectricalTechnologiesModElements.ModElement {
	@ObjectHolder("electrical_technologies:ferronium_block")
	public static final Block block = null;
	public FerroniumBlockBlock(ElectricalTechnologiesModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ferronium_block");
		}
