...
public class FerroniumOreBlock extends ElectricalTechnologiesModElements.ModElement {
	@ObjectHolder("electrical_technologies:ferronium_ore")
	public static final Block block = null;
	public FerroniumOreBlock(ElectricalTechnologiesModElements instance) {
		super(instance, 2);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("ferronium_ore", "ferronium_ore", blockAt -> {
