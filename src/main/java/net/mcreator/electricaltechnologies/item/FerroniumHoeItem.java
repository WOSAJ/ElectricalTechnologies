...
public class FerroniumHoeItem extends ElectricalTechnologiesModElements.ModElement {
	@ObjectHolder("electrical_technologies:ferronium_hoe")
	public static final Item block = null;
	public FerroniumHoeItem(ElectricalTechnologiesModElements instance) {
		super(instance, 11);
	}
